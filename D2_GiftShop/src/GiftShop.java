 ...
 * <p>
 * The ranges are separated by commas (<code class=num>,</code>); each range gives its <span class=glow>first ID</span>
 * and<br>
 ...
 * repeated twice. So, <code class=num>55</code> (<code class=num>5</code> twice), <code class=num>6464</code>
 * (<code class=num>64</code> twice), and <code class=num>123123</code> (<code class=num>123</code> twice)<br>
 * would all be invalid IDs.
 * <p>
 * None of the numbers have leading zeroes; <code class=num>0101</code> isn't an ID at all.(<code class=num>101</code>
 * is a<br>
 ...
 * <p>
 * &nbsp;&nbsp;- <code class=num>11-22</code> has two invalid IDs, <code class=glow>11</code> and
 * <code class=glow>22</code>.<br>
 ...
 * &nbsp;&nbsp;- <code class=num>1188511880-1188511890</code> has one invalid ID,
 * <code class=glow>1188511885</code>.<br>
 ...
 * repeated <span class=glow>at least</span> twice. So, <code class=num>12341234</code> (<code class=num>1234</code> two
 * times), <code class=num>123123123</code> (<code class=num>123</code><br>
 * three times), <code class=num>1212121212</code>? (<code class=num>12</code> five times), and
 * <code class=num>1111111</code> (<code class=num>1</code> seven times) are<br>
 * all invalid IDs.
 * <p>
 * From the same example as before:
 * <p>
 * &nbsp;&nbsp;- <code class=num>11-22</code> still has two invalid IDs, <code class=glow>11</code> and
 * <code class=glow>22</code>.<br>
 * &nbsp;&nbsp;- <code class=num>95-115</code> now has two invalid IDs, <code class=glow>99</code> and
 * <code class=glow>111</code>.<br>
 * &nbsp;&nbsp;- <code class=num>998-1012</code> now has two invalid IDs, <code class=glow>999</code> and
 * <code class=glow>1010</code>.<br>
 * &nbsp;&nbsp;- <code class=num>1188511880-1188511890</code> still has one invalid ID,
 * <code class=glow>1188511885</code>.<br>
 ...
 * &nbsp;&nbsp;- <code class=num>38593856-38593862</code> still has one invalid ID,
 * <code class=glow>38593859</code>.<br>
 * &nbsp;&nbsp;- <code class=num>565653-565659</code> now has one invalid ID, <code class=glow>565656</code>.<br>
 * &nbsp;&nbsp;- <code class=num>824824821-824824827</code> now has one invalid ID,
 * <code class=glow>824824824</code>.<br>
 * &nbsp;&nbsp;- <code class=num>2121212118-2121212124</code> now has one invalid ID,
 * <code class=glow>2121212121</code>.
 * <p>
...
public class GiftShop {
	 ...
	 * 		Handles issue with files
	 */
	public static void main(String[] args) throws FileNotFoundException {
		java.io.File file = new File("D2_GiftShop/input.txt");
